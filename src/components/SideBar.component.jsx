...
const SideBar = () => {
  return (
    <aside className="col-span-4 md:col-span-1 py-5 space-y-4 border h-fit shadow-md">
      <div className="avatar flex flex-col items-center">
        ...
        <Link to="/user/dcyar" className="text-sm link link-primary">
          Editar Perfil
        </Link>
      </div>
      ...
      <div className="menu w-full px-4 bg-base-100">
        <div className="menu-title">
          <span className="px-4">Especialidades:</span>
        </div>
